...
# OR THIS MIGHT BE BETTER: https://gist.github.com/simoninithomas/d6adc6edb0a7f37d6323a5e3d2ab72ec#file-dueling-deep-q-learning-with-doom-double-dqns-and-prioritized-experience-replay-ipynb
# I used this person's Dueling code: https://github.com/dxyang/DQN_pytorch/blob/master/model.py
...
class Trainer(object):
    ...
    def train(self):
        ...
        torch.save(self.policy_net, 'final_dueling.pth')
